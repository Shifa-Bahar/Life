 ...
 */
@AndroidEntryPoint
class AnimationOfferCompleteCouponDialog : BaseDialogFragment<DailogAnimationOfferCompleteCouponBinding>(),
  ...
  companion object {
    ...
    fun newInstance(
      offerTitle: String
    ): AnimationOfferCompleteCouponDialog {
...
//  }
  ...
  override fun getLayoutRes(): Int {
    return R.layout.dailog_animation_offer_complete_coupon
  }
