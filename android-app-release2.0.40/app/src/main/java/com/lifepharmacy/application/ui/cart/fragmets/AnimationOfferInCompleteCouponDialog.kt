 ...
 */
@AndroidEntryPoint
class AnimationOfferInCompleteCouponDialog :
  BaseDialogFragment<DailogAnimationOfferIncompleteCouponBinding>(),
  ...
  companion object {
    ...
    fun newInstance(
      offerTitle: String,
      message: String
    ): AnimationOfferInCompleteCouponDialog {
      val dialog = AnimationOfferInCompleteCouponDialog()
      val bundle = Bundle()
      offerTitle?.let {
...
//    })
  ...
  override fun getLayoutRes(): Int {
    return R.layout.dailog_animation_offer_incomplete_coupon
  }
